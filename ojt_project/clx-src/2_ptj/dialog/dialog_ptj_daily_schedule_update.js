...
function onBodyLoad(/* cpr.events.CEvent */ e){
	...
	app.lookup("dmUserInfo").setValue("user_code_ptj",sessionStorage.getItem("USER_NUMBER"));

	app.lookup("dmOnLoad").setValue("user_code_ptj", sessionStorage.getItem("USER_NUMBER"));
...
function onButtonClick(/* cpr.events.CMouseEvent */ e){
	...
	if(confirm("정말 일정을 삭제하시겠습니까?")){
		...
		dataMap.setValue("user_code_ptj",sessionStorage.getItem("USER_NUMBER"));

		dataMap.setValue("ptj_name", sessionStorage.getItem("USER_NAME"));
