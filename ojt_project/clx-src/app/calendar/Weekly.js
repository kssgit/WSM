/************************************************
 * Weekly.js
 * Created at 2020. 5. 6. 오전 11:24:09.
 *
 * @author ryu
 ************************************************/
...
function setCalendarHeaderDates(poStdDate) {
	...
	var voStdDate = moment().subtract(mnWFarFromNow, "weeks");
	
	var vsStrDate = moment(voStdDate).startOf("weeks").format("MM.DD");
	var vsEndDate = moment(voStdDate).endOf("weeks").format("MM.DD");
	
	var vsWeekRng = moment(voStdDate).format("YYYY")+"."+ vsStrDate + " - " + vsEndDate;
...
//		색깔
		vcEvnt.style.setClasses("weekly-schedule-event-title", "red");
